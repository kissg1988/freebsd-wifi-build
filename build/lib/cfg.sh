...
X_CFG_DEFAULT_WAN=${X_CFG_DEFAULT_WAN:="arge0.2"}
X_CFG_DEFAULT_WAN_TYPE=${X_CFG_DEFAULT_WAN_TYPE:="vlan"}
X_CFG_DEFAULT_WAN_VLANID=${X_CFG_DEFAULT_WAN_VLANID:="2"}
X_CFG_DEFAULT_WAN_PARENT=${X_CFG_DEFAULT_WAN_PARENT:="arge0"}
