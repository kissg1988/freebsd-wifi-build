...
X_CFG_DEFAULT_ETHER_TYPE=${X_CFG_DEFAULT_ETHER_TYPE:="ether"}
X_CFG_DEFAULT_HOSTNAME=${X_CFG_DEFAULT_HOSTNAME:="freebsd-wifi"}
X_CFG_DEFAULT_TTY=${X_CFG_DEFAULT_TTY:="ttyu0"}
X_CFG_DEFAULT_WAN_ENABLE=${X_CFG_DEFAULT_WAN_ENABLE:="NO"}
X_CFG_DEFAULT_SWITCH_ENABLE=${X_CFG_DEFAULT_SWITCH_ENABLE:="NO"}
X_CFG_DEFAULT_FORWARDING_ENABLE=${X_CFG_DEFAULT_FORWARDING_ENABLE:="NO"}
X_CFG_DEFAULT_FW_NAT_ENABLE=${X_CFG_DEFAULT_FW_NAT_ENABLE:="NO"}
X_CFG_DEFAULT_DNSMASQ_ENABLE=${X_CFG_DEFAULT_DNSMASQ_ENABLE:="NO"}
X_CFG_DEFAULT_KERNEL_MODULES=${X_CFG_DEFAULT_KERNEL_MODULES:="random bridgestp if_bridge ipfw"}
